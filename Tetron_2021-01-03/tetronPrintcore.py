...
import socket
import sys
# if sys.version_info.major < 3:   # Delete, or update to Python 3
...
import theaterGcoder as gcoder  # Eventually get rid of alias
...
# Copied from Printrun-master/printrun/utils.py --------------------------------
def set_utf8_locale():
